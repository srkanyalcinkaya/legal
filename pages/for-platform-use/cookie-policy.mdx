...
<SEO 
  title="LawLinkGlobal - Cookie Policy" 
  description="Understand how LawLinkGlobal uses essential and functional cookies to enhance your experience. Learn about session security, wallet integrations, and how to manage cookie preferences." 
  canonical="https://legal.lawlinkglobal.com/for-platform-use/cookie-policy"
  keywords="cookies, privacy, blockchain security, LawLinkGlobal, Web3, smart contracts, session security, Sui Network, legal technology"
/>
